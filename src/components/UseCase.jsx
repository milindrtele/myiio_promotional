...
export default function UseCases() {
  ...
  return (
    <section className="bg-[#143D3D] text-white py-16 px-8">
      ...
      <div className="w-[100%] md:w-[72%] mx-auto bg-linear-to-t from-[#1d3d3d] to-[#07080d] border-[10px] border-[#355453] relative rounded-3xl p-8 shadow-lg">
        <h2 className="md-text-5xl text-[#57c2c0]  font-bold mb-6 text-center uppercase tracking-wide">
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm md:text-base">
          {cases.map((item, i) => (
            <div
              key={i}
              className="flex h-[140px] md:h-[100px] items-center border-b border-[#355453] last:border-b-0"
            >
              {/* Left Label */}
              <div className="bg-teal-700 text-white px-4 py-3 font-semibold relative w-[150px] h-[100%] flex items-center justify-center">
                {item.title}
                {/* Little notch */}
                <div
                  className="absolute right-0 top-0 translate-y-[0] translate-x-[100%] w-0 h-0 
              ...
              {/* <div className="bg-[#067a78] text-white font-semibold px-4 py-2 rounded-l-md min-w-[180px] w-[200px]">
                {item.title}
              </div> */}
              {/* Right Content */}
              <div className="relative z-[1] flex-1 flex bg-gradient-to-b from-white to-gray-100 text-gray-800 px-6 py-4 rounded-r-2xl shadow-sm h-[85%] md:h-[80%] m-auto items-center justify-center">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center w-[72%] mx-auto mt-16">
        {/* Left: Text Block */}
